...
function setup(eim, leaderid) {
    ...
    map.spawnMonsterOnGroundBelow(mob, Vector.of(-829, 43));
...
function allMonstersDead(eim) {
	...
	eim.registerMonster(mob);
	eim.getMapInstance(0).spawnMonsterOnGroundBelow(mob, Vector.of(-1787, 335));
    } else {
	eim.getMapInstance(0).spawnNpc(9120026, Vector.of(-405, 335));
    }
}

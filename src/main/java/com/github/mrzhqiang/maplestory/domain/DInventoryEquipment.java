...
public class DInventoryEquipment extends Model implements Cloneable {
    ...
    @Override
    public DInventoryEquipment clone(){
        try {
            DInventoryEquipment cloned = (DInventoryEquipment) super.clone();
            return cloned;

...
import com.github.mrzhqiang.maplestory.domain.DDueyEquipment;
...
public class MapleDueyEquip extends MapleDueyItem implements IEquip, Serializable {
    ...
    public MapleDueyEquip(DDueyItem item) {
        super(item);

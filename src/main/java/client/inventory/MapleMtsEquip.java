...
import com.github.mrzhqiang.maplestory.domain.DMtsEquipment;
...
public class MapleMtsEquip extends MapleMtsItem implements IEquip, Serializable {
    ...
    public MapleMtsEquip(DMtsItem item) {
        super(item);

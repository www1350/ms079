...
public class MapleDueyItem implements IItem, Serializable {

    protected MaplePet pet = null;
    protected MapleRing ring = null;
    protected int itemLevel;

    public final DDueyItem item;

    public MapleDueyItem(DDueyItem item) {
        this.item = item;
        this.itemLevel = 1;
    }

    public IItem copy() {
        MapleDueyItem ret = new MapleDueyItem(item.clone());
        ret.pet = pet;
        return ret;
    }

...
import com.github.mrzhqiang.maplestory.domain.DMtsTransferEquipment;
...
public class MapleMtsTransferEquip extends MapleMtsTransferItem implements IEquip, Serializable {

    private int charmExp = 0;
    private int pvpDamage = 0;

    public DMtsTransferEquipment equipment;

    // super(id, position, (short) 1, (byte) 0);
    // super(id, position, (short) 1, flag);
    /*super(id, position, (int) 1, flag, uniqueid);*/
    public MapleMtsTransferEquip(DMtsTransfer item) {
        super(item);

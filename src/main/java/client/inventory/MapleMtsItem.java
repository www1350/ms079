...
public class MapleMtsItem implements IItem, Serializable {

    protected MaplePet pet = null;
    protected MapleRing ring = null;
    protected int itemLevel;

    public final DMtsItem item;

    public MapleMtsItem(DMtsItem item) {
        this.item = item;
        this.itemLevel = 1;
    }

    public IItem copy() {
        MapleMtsItem ret = new MapleMtsItem(item.clone());
        ret.pet = pet;
        return ret;
    }
